<div>
    <div class="mx-6 mt-6">
        <a href="{{ route('product.listing') }}"
            class="inline-block px-4 py-2 bg-gray-300 text-gray-800 no-underline rounded hover:bg-gray-400">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2 p-6 flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-gray-500 mb-2">Category: {{ optional($product->category)->name ?? '-' }}</p>
                ...
                <div class="flex items-center gap-4 mt-4">
                    @if ($product->quantity > 0)
                        ...
                        <div class="flex items-center border rounded">
                            ...
                            <input type="text" value="{{ $quantity }}" class="w-12 text-center border-none"
                                readonly>
                        ...
                        <div class="bg-white dark:bg-gray-700 shadow rounded p-4 flex flex-col items-center">
                            @if ($item->product_image)
                                <img src="{{ $item->product_image }}" alt="{{ $item->name }}"
                                    class="h-32 object-contain mb-2">
                            @else
